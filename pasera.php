<?php session_start(); 
	if(!isset($_SESSION["pasera_gate"])) {
		echo '<script>window.location.href="index.php"</script>';
	}

	// if(isset($_GET['logout']) && $_SESSION['pasera_gate'] != ''){
	// 	unset($_SESSION['pasera_gate']);
	// 	session_destroy();
	// 	echo "<script>window.location.href='index.php';</script>";
	// }
?>
...
<div class="bar" style="margin: 0px auto; max-width: 1357px;" id="_tables.form.1">
	<div class="d-flex" style="flex-wrap: wrap;">
		...
		<div class="login-section col-md-6 col-sm-12 col-xs-12" style="display:flex;flex-direction:column;">	
			<div class="first-page">
				<div class="twocard first-card">
					<div class="card-content">
						...
						<!-- <div class="logbtn">
							<a type="button" href="?logout" class="logout-btn">Exit</a>
						</div> -->
					</div>
				</div>
				<div class="register">
